            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              ...
              >
                {isDemoLoading ? (
                  ...
                  <><Sparkles className="w-5 h-5" /> Try It Free</>
                )}
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {exploreAreas.map((area, i) => (
              ...
              >
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 ${area.color === 'blue' ? 'bg-blue-100' :
            ...
            <div className="order-2 lg:order-1 bg-slate-50 rounded-2xl p-8 border border-slate-200">
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-slate-200">
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-medium text-slate-900">Succession Planner Alert</div>
                    <div className="text-xs text-slate-500">Worship Director position at risk, 2 successors identified</div>
                  </div>
