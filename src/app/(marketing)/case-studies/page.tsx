        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/20 backdrop-blur-sm mb-6">
              ...
              <span className="text-sm font-medium text-violet-300">Ministry Motion Case Studies</span>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {placeholderCaseStudies.map((cs, i) => (
              ...
              >
                ...
                {/* Type badge */}
                <div className="mb-4">
                  <span className="px-2 py-1 bg-violet-50 text-violet-700 dark:bg-violet-900/20 dark:text-violet-300 text-xs font-medium rounded-md">
                    {cs.type}
                  </span>
                </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {metricCategories.map((cat, i) => {
              ...
              const colorMap: Record<string, string> = {
                ...
                indigo: 'bg-violet-100 text-violet-600 dark:bg-violet-900/30 dark:text-violet-400',
              };
              return (
      ...
      <section className="py-24 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/20 mb-6">
            ...
            <span className="text-sm text-violet-300">Become a Case Study Church</span>
          </div>
